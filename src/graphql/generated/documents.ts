...
export type AccountError = {
  ...
  readonly code: Types.AccountErrorCode;
};
...
export type ConfirmAccount = {
  readonly confirmAccount?: {
    readonly user?: {readonly isActive: boolean} | null;
    readonly errors: ReadonlyArray<{
      readonly field?: string | null;
      readonly code: Types.AccountErrorCode;
    }>;
...
export type GetHeaderMenu = {
  readonly menu?: {
    readonly items?: ReadonlyArray<{
      readonly id: string;
      readonly name: string;
      readonly page?: {readonly slug: string} | null;
      readonly children?: ReadonlyArray<{
        ...
        readonly children?: ReadonlyArray<{
          ...
          readonly children?: ReadonlyArray<{
            ...
            readonly translation?: {readonly name: string} | null;
          }> | null;
          readonly category?: {
            readonly slug: string;
            readonly name: string;
...
export type HeaderMenuItemFragment = {
  readonly id: string;
  readonly name: string;
  readonly page?: {readonly slug: string} | null;
  readonly children?: ReadonlyArray<{
...
export type HeaderMenuLinkFragment = {
  readonly name: string;
  readonly page?: {readonly slug: string} | null;
  readonly translation?: {readonly name: string} | null;
};

export type HeaderDropdownMenuFragment = {
  readonly name: string;
  readonly children?: ReadonlyArray<{
    readonly id: string;
    readonly name: string;
...
export type HeaderMenuDropdownItemFragment = {
  readonly name: string;
  readonly category?: {readonly slug: string; readonly name: string} | null;
  readonly translation?: {readonly name: string} | null;
};

export type HeaderMenuItemTranslation = {
  readonly translation?: {readonly name: string} | null;
};
        ...
        readonly children?: {
          readonly edges: ReadonlyArray<{
            readonly node: {
              ...
              readonly translation?: {readonly name?: string | null} | null;
            };
          }>;
        } | null;
        readonly translation?: {readonly name?: string | null} | null;
...
export type CategoryNavLinksItemFragment = {
  readonly id: string;
  readonly level: number;
  readonly name: string;
  readonly slug: string;
...
export type CategoryNavLinkFragment = {
  readonly name: string;
  readonly slug: string;
};
...
export type NavCollectionsItem = {
  readonly id: string;
  readonly name: string;
  readonly slug: string;
  readonly translation?: {readonly name?: string | null} | null;
...
export type CollectionNavLinksItemFragment = {
  readonly id: string;
  readonly name: string;
  readonly slug: string;
};

export type CollectionNavLinkFragment = {
  readonly name: string;
  readonly slug: string;
};
...
export type GetCategoryIds = {
  readonly categories?: {
    readonly edges: ReadonlyArray<{readonly node: {readonly id: string}}>;
    readonly pageInfo: {
  ...
  readonly attributes?: {
    readonly edges: ReadonlyArray<{
      readonly node: {
        ...
        readonly type?: Types.AttributeTypeEnum | null;
        readonly inputType?: Types.AttributeInputTypeEnum | null;
        readonly translation?: {readonly name: string} | null;
        readonly choices?: {
          readonly edges: ReadonlyArray<{
            readonly node: {
...
export type ProductAttributeValueFragment = {
  readonly name?: string | null;
  readonly slug?: string | null;
};
...
export type Address = {
  ...
  readonly country: {readonly code: string; readonly country: string};
};
...
export type UpdateCheckoutBillingAddress = {
  readonly checkoutBillingAddressUpdate?: {
    readonly errors: ReadonlyArray<{
      readonly field?: string | null;
      readonly code: Types.CheckoutErrorCode;
    }>;
  } | null;
};
...
export type GetAddressValidationRules = {
  readonly addressValidationRules?: {
    readonly postalCodeMatchers: ReadonlyArray<string>;
    readonly postalCodeExamples: ReadonlyArray<string>;
    readonly countryAreaChoices: ReadonlyArray<{
      readonly raw?: string | null;
      readonly verbose?: string | null;
    }>;
  } | null;
};
...
export type GetCheckout = {
  readonly checkout?: {
    ...
    readonly shippingMethod?: {readonly id: string} | {} | null;
    readonly shippingMethods: ReadonlyArray<{
      readonly id: string;
...
export type GetCountryCodes = {
  readonly channel?: {
    readonly countries?: ReadonlyArray<{readonly code: string}> | null;
  } | null;
};
...
export type UpdateCheckoutEmail = {
  readonly checkoutEmailUpdate?: {
    readonly errors: ReadonlyArray<{
      readonly field?: string | null;
      readonly code: Types.CheckoutErrorCode;
    }>;
...
export type UpdateCheckoutShippingAddress = {
  readonly checkoutShippingAddressUpdate?: {
    readonly errors: ReadonlyArray<{
      readonly field?: string | null;
      readonly code: Types.CheckoutErrorCode;
    }>;
...
export type UpdateCheckoutDeliveryMethod = {
  readonly checkoutDeliveryMethodUpdate?: {
    readonly errors: ReadonlyArray<{
      readonly field?: string | null;
      readonly code: Types.CheckoutErrorCode;
    }>;
...
export type CreateCheckout = {
  readonly checkoutCreate?: {
    readonly checkout?: {readonly id: string} | null;
    readonly errors: ReadonlyArray<{
      readonly field?: string | null;
      readonly code: Types.CheckoutErrorCode;
    }>;
...
export type GetCheckoutSummary = {
  readonly checkout?: {
    ...
    readonly lines: ReadonlyArray<{
      ...
      readonly totalPrice: {
        readonly currency: string;
        readonly net: {readonly amount: number};
...
export const AccountError = new TypedDocumentString(
  ...
  code
    ...
    `,
  {fragmentName: 'accountError'},
) as unknown as TypedDocumentString<AccountError, unknown>;
export const HeaderMenuItemTranslation = new TypedDocumentString(
  ...
  translation(languageCode: $languageCode) {
    ...
    `,
  {fragmentName: 'headerMenuItemTranslation'},
) as unknown as TypedDocumentString<HeaderMenuItemTranslation, unknown>;
export const HeaderMenuLinkFragment = new TypedDocumentString(
  ...
  {fragmentName: 'headerMenuLinkFragment'},
) as unknown as TypedDocumentString<HeaderMenuLinkFragment, unknown>;
export const HeaderMenuDropdownItemFragment = new TypedDocumentString(
  ...
  {fragmentName: 'headerMenuDropdownItemFragment'},
) as unknown as TypedDocumentString<HeaderMenuDropdownItemFragment, unknown>;
...
fragment headerMenuItemTranslation on MenuItem {
  ...
  {fragmentName: 'headerDropdownMenuFragment'},
) as unknown as TypedDocumentString<HeaderDropdownMenuFragment, unknown>;
...
fragment headerMenuItemTranslation on MenuItem {
  ...
  {fragmentName: 'headerMenuItemFragment'},
) as unknown as TypedDocumentString<HeaderMenuItemFragment, unknown>;
export const CategoryNavLinkFragment = new TypedDocumentString(
  ...
  slug
    ...
    `,
  {fragmentName: 'categoryNavLinkFragment'},
) as unknown as TypedDocumentString<CategoryNavLinkFragment, unknown>;
export const CategoryNavLinksItemFragment = new TypedDocumentString(
  ...
  {fragmentName: 'categoryNavLinksItemFragment'},
) as unknown as TypedDocumentString<CategoryNavLinksItemFragment, unknown>;
...
fragment categoryNavLinkFragment on Category {
  ...
  {fragmentName: 'navCategoriesItem'},
) as unknown as TypedDocumentString<NavCategoriesItem, unknown>;
export const CollectionNavLinkFragment = new TypedDocumentString(
  ...
  slug
    ...
    `,
  {fragmentName: 'collectionNavLinkFragment'},
) as unknown as TypedDocumentString<CollectionNavLinkFragment, unknown>;
export const CollectionNavLinksItemFragment = new TypedDocumentString(
  ...
  {fragmentName: 'collectionNavLinksItemFragment'},
) as unknown as TypedDocumentString<CollectionNavLinksItemFragment, unknown>;
...
fragment collectionNavLinkFragment on Collection {
  ...
  {fragmentName: 'navCollectionsItem'},
) as unknown as TypedDocumentString<NavCollectionsItem, unknown>;
export const Money = new TypedDocumentString(
  ...
  amount
    ...
    `,
  {fragmentName: 'money'},
) as unknown as TypedDocumentString<Money, unknown>;
export const ProductCardPricing = new TypedDocumentString(
  ...
  {fragmentName: 'productCardPricing'},
) as unknown as TypedDocumentString<ProductCardPricing, unknown>;
export const Image = new TypedDocumentString(
  ...
  alt
    ...
    `,
  {fragmentName: 'image'},
) as unknown as TypedDocumentString<Image, unknown>;
export const ProductCardCollectionName = new TypedDocumentString(
  ...
  name
    ...
    `,
  {fragmentName: 'productCardCollectionName'},
) as unknown as TypedDocumentString<ProductCardCollectionName, unknown>;
...
) as unknown as TypedDocumentString<ProductCard, unknown>;
...
) as unknown as TypedDocumentString<PageInfo, unknown>;
export const ProductAttributeValueFragment = new TypedDocumentString(
  ...
  slug
    ...
    `,
  {fragmentName: 'productAttributeValueFragment'},
) as unknown as TypedDocumentString<ProductAttributeValueFragment, unknown>;
export const ProductAttributeFragment = new TypedDocumentString(
  ...
  {fragmentName: 'productAttributeFragment'},
...
) as unknown as TypedDocumentString<Address, unknown>;
export const CheckoutError = new TypedDocumentString(
  ...
  code
    ...
    `,
  {fragmentName: 'checkoutError'},
) as unknown as TypedDocumentString<CheckoutError, unknown>;
...
export const UpdateCheckoutDeliveryMethodDocument = new TypedDocumentString(`
  ...
  UpdateCheckoutDeliveryMethodVariables
>;
